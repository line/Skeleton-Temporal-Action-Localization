...
def load_babel_dataset(d_folder="/workspace/VHdata/BABEL/babel_v1.0_release"):
...
def store_seq_fps(amass_p):
    ...
    dest_fp = "../data_created/featp_2_fps.json"
...
def store_ntu_jpos(smplh_model_p, dest_jpos_p, amass_p):
    ...
    featp_2_fps = read_json("../data_created/featp_2_fps.json")
...
def main():
    ...
    amass_p = "/workspace/VHdata/AMASS/"
    ...
    smplh_model_p = "/workspace/yu/smplx/models_cleaned_merged/SMPLH_male.pkl"
    # model is generated by https://github.com/vchoutas/smplx
    jpos_p = "../data_created/amass/babel_joint_pos"
